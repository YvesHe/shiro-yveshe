...
public class Role implements Serializable {
    private static final long serialVersionUID = -3650756272765574706L;
    private Long id; // 编号
    ...
    public String toString() {
        return "Role{" + "id=" + id + ", role='" + role + '\'' + ", description='" + description + '\'' + ", resourceIds=" + resourceIds + ", available=" + available + '}';
    }
}
