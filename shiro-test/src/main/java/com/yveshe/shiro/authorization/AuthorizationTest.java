...
public class AuthorizationTest {
    ...
    public static void main(String[] args) {
        ...
        Factory<org.apache.shiro.mgt.SecurityManager> factory = new IniSecurityManagerFactory("classpath:permission/shiro-permission.ini");
        ...
        if (isAuthenticated) {
            ...
            try {// 检查角色
                ...
                subject.checkRoles(Arrays.asList("role1", "role22"));
